...
let myString = "hasan has"
console.log('The output will be my name');
// console.log(`${myString}is my name`);
// console.log(myString,'is my name');
console.log(myString);
myString = 'Thomas Feder';
console.log('The output changes as Thomas Feder');
console.log(myString);
